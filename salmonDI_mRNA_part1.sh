...
Usage()
{
	...
	printf "\tFunction\n"
	printf "\tAnalyze salmon distal intestine and head kidney RNA-seq data, including quality control of raw fastq; trim adapter; quality control of trimmed fastq; align to genome; and generate read counts matrix.\n\n"
